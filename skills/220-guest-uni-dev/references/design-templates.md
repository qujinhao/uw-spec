...
| Tab | 页面路径 | 图标 | 说明 |
|-----|---------|------|------|
| 首页 | pages/index/index | home | Banner+分类入口+内容流 |
| 分类 | pages/category/index | category | 分类网格+筛选 |
| 发现 | pages/discovery/index | compass | 社区内容+热门推荐 |
| 我的 | pages/user/index | user | 个人中心+功能入口 |
...
```json
{
  "pages": [
    ...
    { "path": "pages/discovery/index", "style": { "navigationBarTitleText": "发现" } },
    { "path": "pages/user/index", "style": { "navigationBarTitleText": "我的" } },
    { "path": "pages/article/detail", "style": { "navigationBarTitleText": "详情" } },
  ...
  "tabBar": {
    ...
    "list": [
      ...
      { "pagePath": "pages/discovery/index", "text": "发现", "iconPath": "static/tabbar/discovery.png", "selectedIconPath": "static/tabbar/discovery-active.png" },
